...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        # Set new decay rate for non-linear decaying function
#        self.decay_rate=math.exp((-0.02)*self.env.t)
        self.trial = 1
...
#            self.epsilon = math.exp((-0.007)*self.trial)
            self.epsilon = math.cos(0.007*self.trial)
        self.trial += 1
        return None
